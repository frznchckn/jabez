...
static cmd_t cmds[] = {
  ...
  {cmd_boot_from_flash, "boot_from_flash",
   "boot_from_flash",    "et the SAM7X to boot from flashs"},
  {cmd_flash, "flash",
   "flash <file>", "upload <file> to flash using samba.bin"},   
  {cmd_read, "read",
   "read <file> <addr> <len>", "write <len> bytes at <addr> to <file> using R commands"},   
